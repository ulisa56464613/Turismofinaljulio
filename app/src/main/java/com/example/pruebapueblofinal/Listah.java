...
public class Listah extends AppCompatActivity {
    ...
    public void crearLista(){
        ...
        listaHoteles.add(new Moldehotel("Hotel el descanso2","230000",R.drawable.ho1));
        listaHoteles.add(new Moldehotel("Hotel el descanso3","230000",R.drawable.ho1));
        listaHoteles.add(new Moldehotel("Hotel el descanso4","230000",R.drawable.ho1));
        listaHoteles.add(new Moldehotel("Hotel el descanso5","230000",R.drawable.ho1));
